...
/** Ez az osztály felel azért, hogy irányítsa a többi osztály által létrehozott metódusokat, illetve ez köti majd össze a megjelenítéssel és a megvalósítással kapcsolatos osztályokat. (Magyarul ez az osztály irányítja  atöbbit) */
...
/** A MalomController osztály konstruktora ami beállít egy kivülről kapott pályát és össze köti ezt a megjelenítésért felelős osztállyal. */
    public MalomController(MalomModel malomModel){
        this.malomModel = malomModel;    //megkapunk kivülről egy pályát
        this.malomView = new MalomView(this, this.malomModel);//ez szolgáltattja a dolgokat a view számára
    }
